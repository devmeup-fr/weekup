...
import '../widgets/exemple_alarm_shortcut_button.dart';
import '../widgets/exemple_alarm_tile.dart';
import 'exemple_alarm_edit_screen.dart';
import 'exemple_alarm_ring_screen.dart';
...
class _ExampleAlarmHomeScreenState extends State<ExampleAlarmHomeScreen> {
  ...
  void initState() {
    super.initState();
    AlarmPermissionsService.checkNotificationPermission();
    if (Alarm.android) {
      AlarmPermissionsService.checkAndroidScheduleExactAlarmPermission();
    }
